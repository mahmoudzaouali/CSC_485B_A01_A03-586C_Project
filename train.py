...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from):
    ...
    profile_iterations = {100, 500, 1000}
    ...
    for iteration in range(first_iter, opt.iterations + 1):   
        ...
        if iteration in profile_iterations:
            torch.cuda.cudart().cudaProfilerStart()
        torch.cuda.nvtx.range_push("please work")
        ...
        # If you want to test render, which is your code, you will have to push/add a call to it here
        # torch.cuda.nvtx.range_push("renderCuda")
